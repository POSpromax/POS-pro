...
export const INITIAL_RAW_MATERIALS: RawMaterial[] = [
  ...
  { id: 'raw-b1', name: 'Bakso Daging', unit: 'pcs', stockQuantity: 17698, minStockThreshold: 20, costPerUnit: 1500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b2', name: 'Bakso Isi Daging Sedang', unit: 'pcs', stockQuantity: 10706, minStockThreshold: 5000, costPerUnit: 2500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b3', name: 'BAKSO KEJU', unit: 'pcs', stockQuantity: 23094, minStockThreshold: 10000, costPerUnit: 3000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b4', name: 'Bakso Polos Kecil', unit: 'pcs', stockQuantity: 10158, minStockThreshold: 5000, costPerUnit: 1000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b5', name: 'Bakso Urat', unit: 'pcs', stockQuantity: 14835, minStockThreshold: 15, costPerUnit: 2200, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b6', name: 'Bakso Urat Gimbal', unit: 'pcs', stockQuantity: 68, minStockThreshold: 50, costPerUnit: 3500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b7', name: 'Bakso Urat Jumbo', unit: 'pcs', stockQuantity: 954, minStockThreshold: 100, costPerUnit: 8500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },
  { id: 'raw-b8', name: 'Mie Ayam', unit: 'pcs', stockQuantity: 7719, minStockThreshold: 10, costPerUnit: 4000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'MENU' },

  // DAPUR (Bahan Baku Mentah & Bumbu)
  { id: 'raw-d1', name: 'Beras', unit: 'kg', stockQuantity: 5, minStockThreshold: 5, costPerUnit: 14000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d2', name: 'Keju', unit: 'pcs', stockQuantity: 6, minStockThreshold: 10, costPerUnit: 25000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d3', name: 'Minyak', unit: 'pcs', stockQuantity: 2, minStockThreshold: 10, costPerUnit: 18000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d4', name: 'Rumput Laut', unit: 'pcs', stockQuantity: 5, minStockThreshold: 10, costPerUnit: 15000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d5', name: 'Skm', unit: 'pcs', stockQuantity: 3, minStockThreshold: 10, costPerUnit: 12000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d6', name: 'Skm Coklat', unit: 'pcs', stockQuantity: 2, minStockThreshold: 10, costPerUnit: 12500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d7', name: 'Sunlight', unit: 'pcs', stockQuantity: 4, minStockThreshold: 10, costPerUnit: 15000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d8', name: 'Susu Skm', unit: 'pcs', stockQuantity: 5, minStockThreshold: 10, costPerUnit: 12000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d9', name: 'Terigu', unit: 'pcs', stockQuantity: 2, minStockThreshold: 10, costPerUnit: 11000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d10', name: 'Tiga Sapi', unit: 'pcs', stockQuantity: 4, minStockThreshold: 10, costPerUnit: 13000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d11', name: 'Bihun', unit: 'pcs', stockQuantity: 45, minStockThreshold: 10, costPerUnit: 5000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d12', name: 'gula', unit: 'pcs', stockQuantity: 29, minStockThreshold: 10, costPerUnit: 17000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d13', name: 'KECAP', unit: 'pack', stockQuantity: 29, minStockThreshold: 5, costPerUnit: 22000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d14', name: 'Mie', unit: 'pcs', stockQuantity: 40, minStockThreshold: 10, costPerUnit: 4500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d15', name: 'Mozza', unit: 'pcs', stockQuantity: 22, minStockThreshold: 10, costPerUnit: 45000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d16', name: 'Mutiara', unit: 'pcs', stockQuantity: 125, minStockThreshold: 10, costPerUnit: 8000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d17', name: 'Nata D Coco', unit: 'pcs', stockQuantity: 48, minStockThreshold: 10, costPerUnit: 14000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d18', name: 'Nutrijel', unit: 'pcs', stockQuantity: 23, minStockThreshold: 10, costPerUnit: 4500, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d19', name: 'Sagu Tani', unit: 'pcs', stockQuantity: 23, minStockThreshold: 10, costPerUnit: 16000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d20', name: 'Sasa', unit: 'pcs', stockQuantity: 16, minStockThreshold: 10, costPerUnit: 6000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d21', name: 'Saus Cabe', unit: 'pcs', stockQuantity: 71, minStockThreshold: 10, costPerUnit: 15000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d22', name: 'SAUS TOMAT', unit: 'pack', stockQuantity: 66, minStockThreshold: 10, costPerUnit: 15000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d23', name: 'Swallow', unit: 'pcs', stockQuantity: 12, minStockThreshold: 10, costPerUnit: 5000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d24', name: 'Teh Bendera', unit: 'pack', stockQuantity: 39, minStockThreshold: 10, costPerUnit: 8000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-d25', name: 'Tepung Beras', unit: 'pcs', stockQuantity: 30, minStockThreshold: 10, costPerUnit: 12000, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'DAPUR' },
  { id: 'raw-pa-1', name: 'Bakso Daging', unit: 'pcs', stockQuantity: 500, minStockThreshold: 100, costPerUnit: 1500, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'MENU' },
  { id: 'raw-pa-2', name: 'Bakso Isi Daging Sedang', unit: 'pcs', stockQuantity: 300, minStockThreshold: 50, costPerUnit: 2500, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'MENU' },
  { id: 'raw-pa-3', name: 'Bakso Polos Kecil', unit: 'pcs', stockQuantity: 400, minStockThreshold: 100, costPerUnit: 1000, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'MENU' },
  { id: 'raw-pa-4', name: 'Bakso Urat', unit: 'pcs', stockQuantity: 200, minStockThreshold: 50, costPerUnit: 2200, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'MENU' },
  { id: 'raw-pa-5', name: 'Mie Ayam', unit: 'pcs', stockQuantity: 150, minStockThreshold: 30, costPerUnit: 4000, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'MENU' },
  { id: 'raw-pa-6', name: 'Teh Bendera', unit: 'pack', stockQuantity: 20, minStockThreshold: 5, costPerUnit: 8000, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'DAPUR' },

  // KEMASAN (Wadah Bawa Pulang / Take-Away)
  { id: 'raw-k1', name: 'Rice Bowl Take Away', unit: 'pcs', stockQuantity: 300, minStockThreshold: 50, costPerUnit: 1800, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'KEMASAN', takeAwayUsagePerItem: 1 },
  { id: 'raw-k2', name: 'Cup Plastik Minuman', unit: 'pcs', stockQuantity: 500, minStockThreshold: 100, costPerUnit: 900, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'KEMASAN', takeAwayUsagePerItem: 1 },
  { id: 'raw-k3', name: 'Kantong Kresek', unit: 'pcs', stockQuantity: 400, minStockThreshold: 100, costPerUnit: 300, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'KEMASAN', takeAwayUsagePerItem: 1 },
  { id: 'raw-k4', name: 'Sendok Plastik', unit: 'pcs', stockQuantity: 450, minStockThreshold: 100, costPerUnit: 200, branchId: '00000000-0000-4000-a000-000000000010', branchName: 'Pasirmulya Bogor', group: 'KEMASAN', takeAwayUsagePerItem: 1 },
  { id: 'raw-k5', name: 'Rice Bowl Take Away', unit: 'pcs', stockQuantity: 150, minStockThreshold: 30, costPerUnit: 1800, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'KEMASAN', takeAwayUsagePerItem: 1 },
  { id: 'raw-k6', name: 'Cup Plastik Minuman', unit: 'pcs', stockQuantity: 200, minStockThreshold: 50, costPerUnit: 900, branchId: '00000000-0000-4000-a000-000000000020', branchName: 'Pasar Anyar', group: 'KEMASAN', takeAwayUsagePerItem: 1 }
];
...
export const INITIAL_TABLES: RestaurantTable[] = [
  ...
  { id: 'tbl-13', number: '13', capacity: 4, status: 'FREE', isSelfOrderEnabled: true, branchId: '00000000-0000-4000-a000-000000000010' },
  { id: 'tbl-14', number: '14', capacity: 4, status: 'FREE', isSelfOrderEnabled: true, branchId: '00000000-0000-4000-a000-000000000010' },
  { id: 'tbl-15', number: '15', capacity: 4, status: 'FREE', isSelfOrderEnabled: true, branchId: '00000000-0000-4000-a000-000000000010' },
